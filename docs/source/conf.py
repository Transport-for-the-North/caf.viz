...
version = str(caf.viz.__version__)
release = version
...
modindex_common_prefix = ["caf.", "caf.viz."]
...
html_theme_options = {
    ...
    "icon_links": [
        {
            "name": "GitHub",
            "url": "https://github.com/transport-for-the-north/caf.viz",
    ...
    "external_links": [
        {
            "name": "Changelog",
            "url": "https://github.com/transport-for-the-north/caf.viz/releases",
        },
        {
            "name": "Issues",
            "url": "https://github.com/transport-for-the-north/caf.viz/issues",
        },
        {
            "name": "CAF Handbook",
    ...
    "announcement": """
        ...
        <a href="https://github.com/transport-for-the-north/caf.viz/issues/new/choose">caf.viz repository</a>.
    """,
}
html_context = {
